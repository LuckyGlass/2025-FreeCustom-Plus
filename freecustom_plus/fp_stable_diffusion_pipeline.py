        ...
        **kwargs,
        ...
        Args:
            prompt (`List[str]`, *optional*):
                The prompts to guide image generation. The first element is the generation prompt and the others are the descriptions of the reference.
            ...
            latents (`torch.Tensor`):
                The latents in the VAE embedding space. The first element is the noise for image generation and the others are the VAE embedding of the reference.
            ...
            referent_names (`List[str]`):
                The names of the referent items. The order should be the same as the reference images.
            mrsa (`MultiReferenceSelfAttention`):
                The MRSA module used to hack the UNet.
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = torch.cat([base_latent] * 2) if self.do_classifier_free_guidance else base_latent
                ...
                if i == len(timesteps) - 1 or ((i + 1) > num_warmup_steps and (i + 1) % self.scheduler.order == 0):
                    ...
                    if callback is not None and i % callback_steps == 0:
                        ...
                        callback(step_idx, t, base_latent)
